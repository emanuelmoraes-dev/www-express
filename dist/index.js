 ...
 */
exports.default = (function (app, debug, security) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    server.listen(port);
                    server.on('error', function (err) { return onError(err, port, reject); });
                    server.on('listening', function () { return onListening(server, debug, resolve); });
                })
                /**
 ...
 */
function onError(error, port, reject) {
    reject(error);
